...
- Load the data
- Create a dataframe to deal only with the 2018 payouts
- Find the number of payouts from each year
- Find average amount
  - Use the <mean> function to find that the average has increased
- Filter the 2018 payouts for settlements over $1 million
 

- Make a separate dataframe for the decade before (2008-2018)
